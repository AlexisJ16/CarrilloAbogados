...
export default function LoginPage() {
  ...
  const onSubmit = async (data: LoginFormData) => {
    ...
    try {
      ...
      // Redirect based on role will be handled by middleware or in AuthContext
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div>
          ...
          <p className="mt-2 text-center text-sm text-gray-600">
            Acceda a su cuenta de Carrillo Abogados
          </p>
        </div>
        ...
        <form className="mt-8 space-y-6" onSubmit={handleSubmit(onSubmit)}>
          <div className="-space-y-px rounded-md shadow-sm">
            ...
            <div>
              ...
              <input
                ...
                } rounded-t-md text-gray-900 placeholder-gray-500 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 sm:text-sm`}
            ...
            <div className="relative">
              ...
              <input
                ...
                } rounded-b-md text-gray-900 placeholder-gray-500 focus:z-10 focus:border-primary-500 focus:outline-none focus:ring-primary-500 sm:text-sm`}
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="bg-gray-50 px-2 text-gray-500">O continúe con</span>
            </div>
          </div>

          {/* Google OAuth Button (for staff) */}
          <div>
            <button
              type="button"
              ...
              onClick={() => {
                ...
                alert('Google OAuth disponible próximamente para personal del bufete');
              }}
            >
              ...
              Continuar con Google (Personal Bufete)
            </button>
          </div>
        </form>
