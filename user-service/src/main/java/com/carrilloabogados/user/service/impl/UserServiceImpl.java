package com.carrilloabogados.user.service.impl;
...
import com.carrilloabogados.user.dto.UserDto;
import com.carrilloabogados.user.exception.wrapper.UserObjectNotFoundException;
import com.carrilloabogados.user.helper.UserMappingHelper;
import com.carrilloabogados.user.repository.UserRepository;
import com.carrilloabogados.user.service.UserService;
...
public class UserServiceImpl implements UserService {
	...
	public UserDto findById(final Integer userId) {
		...
		return this.userRepository.findById(userId)
				.map(UserMappingHelper::map)
				.orElseThrow(() -> new UserObjectNotFoundException("User with id: %d not found".formatted(userId)));
	}
	...
	public UserDto findByUsername(final String username) {
		...
		return UserMappingHelper.map(this.userRepository.findByCredentialUsername(username)
				.orElseThrow(() -> new UserObjectNotFoundException("User with username: %s not found".formatted(username))));
	}
