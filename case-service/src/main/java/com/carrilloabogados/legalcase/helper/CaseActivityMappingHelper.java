...
public interface CaseActivityMappingHelper {
    ...
    public static CaseActivityDto map(final CaseActivity caseActivity) {
        return CaseActivityDto.builder()
                ...
                .caseId(caseActivity.getLegalCase() != null ? caseActivity.getLegalCase().getCaseId() : null)
                ...
                .createdAt(toLocalDateTime(caseActivity.getCreatedAt()))
                .updatedAt(toLocalDateTime(caseActivity.getUpdatedAt()))
                .build();
    }
