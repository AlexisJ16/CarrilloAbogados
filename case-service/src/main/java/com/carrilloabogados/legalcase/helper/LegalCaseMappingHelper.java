...
public interface LegalCaseMappingHelper {
	...
	public static LegalCaseDto map(final LegalCase legalCase) {
		return LegalCaseDto.builder()
				...
				.caseType(legalCase.getCaseType() != null ? 
						CaseTypeMappingHelper.map(legalCase.getCaseType()) : null)
				...
				.activities(legalCase.getActivities() != null ? 
						legalCase.getActivities().stream()
								.map(CaseActivityMappingHelper::map)
								.collect(Collectors.toSet()) : null)
				.caseDocuments(legalCase.getCaseDocuments() != null ? 
						legalCase.getCaseDocuments().stream()
	...
	public static LegalCase map(final LegalCaseDto legalCaseDto) {
		return LegalCase.builder()
				...
				.caseType(legalCaseDto.getCaseType() != null ? 
						CaseTypeMappingHelper.map(legalCaseDto.getCaseType()) : null)
