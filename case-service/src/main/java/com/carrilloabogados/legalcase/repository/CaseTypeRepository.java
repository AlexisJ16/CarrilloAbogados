...
public interface CaseTypeRepository extends JpaRepository<CaseType, Integer> {
    ...
    /**
     * Find case types by complexity level range
     */
    List<CaseType> findByComplexityLevelBetweenAndIsActiveTrueOrderByComplexityLevelAsc(Integer minLevel,
            Integer maxLevel);
     ...
     */
    List<CaseType> findByHourlyRateGreaterThanEqualAndHourlyRateIsNotNullAndIsActiveTrueOrderByHourlyRateAsc(
            Double minRate);
